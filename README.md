...
- export page - exports existing page to several supported formats
...
Example 'addpage' goal configurations:
<configuration>
    <parent>
...
Example 'addblogentry' goal configurations:
<configuration>
    <space>Example space</space>
...
Example 'addcomment' goal configurations:
<configuration>
   <page>
        <space>Example space</space>
...
Example 'addattachment' goal configurations:
<configuration>
    <page>
        <space>Example space</space>
...
Example 'exportpage' goal configurations:
<configuration>
    <page>
        <space>Example space</space>
        <title>My page</title>
